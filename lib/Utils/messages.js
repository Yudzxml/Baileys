...
export const generateWAMessageContent = async (message, options) => {
    ...
    // 7.6.0: the legacy "unifiedResponse" content shortcut was removed.
    // Use the integrated MessageBuilder instead:
    //   new AIRich(sock).addText('...').addSection(...).send(jid)
    //   sendHtmlApp(sock, jid, html)
