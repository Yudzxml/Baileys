...
// Yudzxml@Changes 02-09-26 --- AI Rich Response / Unified Response support
import { prepareUnifiedResponseMessage } from './rich-response-builder.js';
...
const mediaAnnotation = [
    {
        ...
        newsletter: {
            ...
            newsletterJid: process.env.NEWSLETTER_ID || '120363426771378655@newsletter',
            newsletterName: process.env.NEWSLETTER_NAME || '@yudzxml/baileys',
...
export const prepareWAMessageMedia = async (message, options) => {
    ...
    const { mediaKey, encFilePath, originalFilePath, fileEncSha256, fileSha256, fileLength } = await encryptedStream(uploadData.media, options.mediaTypeOverride || mediaType, {
        ...
        isPtt: uploadData.ptt === true,
        forceOpus: options.forceOpus === true
    });
...
export const generateWAMessageContent = async (message, options) => {
    ...
    // Yudzxml@Changes 02-09-26 --- Add support for AI Rich Response / Unified Response
    else if (hasNonNullishProperty(message, 'unifiedResponse')) {
        m = prepareUnifiedResponseMessage(message.unifiedResponse);
    }
