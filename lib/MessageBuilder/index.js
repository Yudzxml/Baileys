...
/**
 * Port notice (2026-09): adapted to run on @yudzxml/baileys 7.6.0.
 * Only import paths were touched; the builder logic is unchanged
 * and all original credits above remain in force.
 */
