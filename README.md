...
- [Authentication](#-authentication)
  - [Using QR Code](#1-using-qr-code)
  - [Using Pairing Code](#2-using-pairing-code)
  - [Custom Pairing Code](#3-custom-pairing-code)
  - [Auth State Options](#auth-state-options)
- [Configuration](#-configuration)
- [Handling Events](#-handling-events)
- [Sending Messages](#-sending-messages)
  - [Text, Media & Mentions](#text--mentions)
  - [Buttons, Lists & Carousels](#interactive-buttons)
  - [Poll, Album, Event & Group Status](#poll-messages)
  - [Quick Message Operations](#quick-message-operations)
  - [Business Messages & Queries](#shop--collection-messages)
  - [Dugong Special Types](#dugong-special-message-types)
- [Communities & Newsletters](#-communities--newsletters)
- [Groups & Privacy](#-groups--privacy)
- [AI Rich Response](#-ai-rich-response-messagebuilder-47)
  - [AIRich — Basic Send](#airich--basic-send)
  - [AIRich — Available Helpers](#airich--available-helpers)
  - [Live Edit — sendEdit()](#live-edit--sendedit)
  - [HTML Mini App (GenAIaeacdsnwHtmlPrimitive)](#html-mini-app--genaiaeacdsnwhtmlprimitive)
...
│   └── index.d.ts / *.map             # IDE IntelliSense support
├── WAProto/
...
| `buttons-carousel.js` | Buttons, list/selection, and carousel demos |
